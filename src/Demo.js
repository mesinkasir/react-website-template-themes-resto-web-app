...
const Demo = () => (
  <div>
    <Helmet>
      ...
      />
      <title>Demo Operasional penggunaan mesin kasir restoran online</title>
      <meta
        name="description"
        content="Cek cara kerja mesin kasir restoran rumah makan cafe online disini ."
      />
      <meta
        content="Demo Operasional penggunaan mesin kasir restoran online"
        property="og:title"
      />
      <meta
        content="Cek cara kerja mesin kasir restoran rumah makan cafe online disini ."
        ...
        <div className="col-12 col-md-12 p-3 text-center">
          ...
          <div className="embed-responsive embed-responsive-16by9 shadow rounded">
            <iframe
              ...
              src="https://www.youtube.com/embed/9sw0D17Tz-8"
              title="mesin kasir restoran online murah"
              allowFullScreen
            />
          </div>
          <p>
            Super simple dan mudah dalam menggunakan mesin kasir online restoran
            ini.
          </p>
        </div>
      </div>
